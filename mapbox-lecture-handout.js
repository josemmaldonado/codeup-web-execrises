...
var marker = new mapboxgl.Marker({color:"red"})
    .setLngLat([-98.46555987364559,29.5691552756167])
    .addTo(map)
...
var saCodeUpMarker = new mapboxgl.Marker({color:"green",draggable:true})
...
// var popup = new mapboxgl.Popup({saCodeUpMarker})
//     .setLngLat([-98.4895,29.4267])
...
var alamoPopup = new mapboxgl.Popup()
    .setHTML("<strong>Remember The Alamo!</strong>")
    .addTo(map)
...
//  *  })
// geocode("218 erskine pl, san antonio, tx", mapBoxKey).then(function (results){
//     console.log(results)
// });
//TODO: Using the geocode method above, add a marker at Codeup to the map

geocode("219 E Houston St #275, San Antonio, TX 78205",mapBoxKey).then(function (results){
